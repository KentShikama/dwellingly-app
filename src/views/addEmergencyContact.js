...
const AddEmergencyContact = (props) => {
    ...
    useMountEffect(() => {
        ...
        setEditMode(true);
        axios
            .get(`${process.env.REACT_APP_API_URL}/api/emergencycontacts/${id}`, makeAuthHeaders(userContext))
            .then(({ data }) => {
    ...
    const formHandler = data => {
        const startPost = () => axios.post(`${process.env.REACT_APP_API_URL}/api/emergencycontacts`, data, makeAuthHeaders(userContext));
        const startPut = () => axios.put(`${process.env.REACT_APP_API_URL}/api/emergencycontacts/${data.id}`, data, makeAuthHeaders(userContext));
