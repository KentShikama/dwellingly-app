...
const EmergencyContacts = () => {
    ...
    useMountEffect(() => {
      axios
          .get(`${process.env.REACT_APP_API_URL}/api/emergencycontacts`, makeAuthHeaders(userContext))
          .then(({ data }) => {
    ...
    const handleDelete = id => {
        ...
        axios
            .delete(`${process.env.REACT_APP_API_URL}/api/emergencycontacts/${id}`, makeAuthHeaders(userContext))
            .then(() => {
